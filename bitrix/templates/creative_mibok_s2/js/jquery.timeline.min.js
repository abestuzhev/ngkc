    ...
    var t = {
        init: function (t) {
            var n = e.extend({
                ...
                ajaxFailMessage: "Ajax запрос не выполнен."
            }, t);
            var r = this, i = e("body"), s = r.find(n.itemClass), o = r.find(n.itemOpenClass), u = s.first().width(),
                a = o.first().width(), f = n.closeItemOnTransition;
            ...
            var c = r.find(".timeline_items:first"), h = r.find(".t_line_wrapper:first"),
                p = 300 / 2 - (u + n.itemMargin) * (1 / 2 + l),
                d = (u + n.itemMargin) * s.length + (a + n.itemMargin) + 660, v = r.data("timeline");
            ...
            var t = this, n = t.data("timeline"), r = n.itemWidth + n.options.itemMargin, i = n.currentIndex, s = 0,
                o = e - n.mousestartpos;
            ...
            var n = this, r = n.data("timeline"), i = r.itemWidth + r.options.itemMargin, s = r.currentIndex, o = 0,
                u = t - r.mousestartpos;
            r.mousedown = false;
            ...
            var r = this, i = r.data("timeline"), s = r.find(i.options.itemOpenClass), o = i.options.scrollSpeed,
                u = i.itemOpenWidth, a = i.options.easin, f = i.options.itemMargin;
            s.each(function () {
            ...
            var i = this, s = i.data("timeline"), o = i.find(s.options.itemOpenClass), u = s.options.scrollSpeed,
                a = s.itemOpenWidth, f = s.options.easing;
            o.each(function () {
            ...
            var i = this, s = i.data("timeline"), o = s.options.scrollSpeed, u = s.options.easing, a = s.items,
                f = i.find(".timeline_line").width(), l = -1, c = false;
            a.each(function (r) {
            ...
            if (!n.options.categories) {
                r.each(function () {
                    var t = e(this).attr("data-id"), n = t.split("/"), r = parseInt(n[0], 10),
                        i = e.inArray(n[1], u) != -1 ? e.inArray(n[1], u) : parseInt(n[1], 10), s = parseInt(n[2], 10);
                    if (r < minY) minY = r;
                    if (r > maxY) maxY = r
                });
                minY -= 10;
            ...
            r.each(function (t) {
                var r = e(this).attr("data-id"), i = e(this).attr("data-name"), s = e(this).attr("data-description"),
                    f = r.split("/"), l = parseInt(f[0], 10),
                    c = e.inArray(f[1], u) != -1 ? e.inArray(f[1], u) : parseInt(f[1], 10), h = parseInt(f[2], 10);
                if (typeof a[h] == "undefined") a[h] = {};
                if (typeof a[h][c] == "undefined") a[h][c] = {};
                a[h][c][l] = r;
                var p = t == n.currentIndex ? " active" : "";
                if (n.options.categories) {
                    var d = 105 / monthsDays[c] * l
                } else {
                    var d = 105 / (maxY - minY) * (l - minY)
                }
