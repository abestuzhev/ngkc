...
; /* Start:"a:4:{s:4:"full";s:70:"/bitrix/templates/creative_mibok_s2/js/html5shiv.min.js?15084419302733";s:6:"source";s:55:"/bitrix/templates/creative_mibok_s2/js/html5shiv.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/**
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:136:"/bitrix/components/mibok/iblock.element.add/templates/consent_footer_form/mibok/iblock.element.add.form/.default/script.js?1508440934563";s:6:"source";s:122:"/bitrix/components/mibok/iblock.element.add/templates/consent_footer_form/mibok/iblock.element.add.form/.default/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:67:"/bitrix/templates/creative_mibok_s2/js/modernizr.js?150844193012017";s:6:"source";s:51:"/bitrix/templates/creative_mibok_s2/js/modernizr.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/*!
 * Modernizr v2.8.3
 * www.modernizr.com
 *
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:68:"/bitrix/templates/creative_mibok_s2/js/jquery.min.js?150844193085582";s:6:"source";s:52:"/bitrix/templates/creative_mibok_s2/js/jquery.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:69:"/bitrix/templates/creative_mibok_s2/js/flexibility.js?150844193017382";s:6:"source";s:53:"/bitrix/templates/creative_mibok_s2/js/flexibility.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:75:"/bitrix/templates/creative_mibok_s2/js/swiper.jquery.min.js?150844193068734";s:6:"source";s:59:"/bitrix/templates/creative_mibok_s2/js/swiper.jquery.min.js";s:3:"min";s:59:"/bitrix/templates/creative_mibok_s2/js/swiper.jquery.min.js";s:3:"map";s:68:"/bitrix/templates/creative_mibok_s2/js/maps/swiper.jquery.min.js.map";}"*/
/**
 * Swiper 3.3.1
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:86:"/bitrix/templates/creative_mibok_s2/js/perfect-scrollbar.jquery.min.js?150844193025813";s:6:"source";s:70:"/bitrix/templates/creative_mibok_s2/js/perfect-scrollbar.jquery.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:73:"/bitrix/templates/creative_mibok_s2/js/jquery.fancybox.js?150844193050725";s:6:"source";s:57:"/bitrix/templates/creative_mibok_s2/js/jquery.fancybox.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/*!
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:88:"/bitrix/templates/creative_mibok_s2/js/tooltip/tooltipster.bundle.min.js?150844193039420";s:6:"source";s:72:"/bitrix/templates/creative_mibok_s2/js/tooltip/tooltipster.bundle.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
    ...
    e(function() {
        ...
        e(window).on("load resize", function() {
            ...
            if(992 > s)
            {
                ...
                //
                tli.height("");
                console.log(t(e(".s-line-inner-wrapper > .swiper-slide")) + 20);
                e(".s-line-inner-wrapper").width(t(e(".s-line-inner-wrapper > .swiper-slide")) + 20 );
                tli.perfectScrollbar("update");
                //tli.perfectScrollbar("destroy");
            }
            else
            {
                //tl.perfectScrollbar("destroy");
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:94:"/bitrix/components/mibok/panel_creative.settings/templates/.default/script.js?1487258427114358";s:6:"source";s:77:"/bitrix/components/mibok/panel_creative.settings/templates/.default/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
(function ( $ ) {
    ...
    $.fn.BootSideMenu = function( options ) {
        ...
        newCode += "<div class=\"\">\n";
        newCode += "	<div class=\"panel-wrapper\" data-side=\""+side+"\">\n"+ oldCode+" </div>\n";
        newCode += "</div>";
        newCode += "<div class=\"toggler\">\n";
        newCode += "	<span class=\"glyphicon glyphicon-cog\">&nbsp;</span> \n";
        newCode += "</div>\n";
    ...
    $(document).on('click', '.panel-header .close', function(){
...
$(document).ready(function(){
    $('.panel-settings').BootSideMenu({side:"left", autoClose:true});
    ...
    $('.switcher-block > div').each(function(indx, element){
        var val = $(element).find('input[name="value-color"]').val();
        if(val != '')
        {
            $(element).find(".custom-color").spectrum({
                color: val,
                showButtons: false,
                preferredFormat: "hex",
                showInput: true,
                move: function(color) {
                    ...
                    $(this).parents('.switcher-block > div.active').find('input[name="value-color"]').val(val);
                    ChangePreview();
                },
            });
        }
        ...
        var bSel = $(element).find('input[name="is-selected"]').val();
        if(bSel != 1)
            $(element).find('.simplecolorpicker .color:first-child').removeAttr('data-selected');
    })
...
{
    var action = $('.panel-settings input[name="panel_action"]').val();
    var arSettings = {};
    var bReload = false;
    $('.switcher-block > div').each(function(indx, element){
        var val = $(element).find('input[name="value-color"]').val();
        arSettings[$(element).attr('id')] = val;
        if($(element).attr('id') == 'main_elements' && val != '')
            arSettings[$(element).attr('id') + '_rgba'] = '(' + (hexToRgb(val).r).toString() + ',' + (hexToRgb(val).g).toString()  + ',' + (hexToRgb(val).b).toString() + ',' + '0.8)';
        if(val != '')
            bReload = true;
    })
    param = JSON.stringify(arSettings);
    //$.post("/bitrix/components/mibok/panel_creative.settings/ajax.php",{action: action, sub_action: 'CHANGE_PREVIEW', params: param},function(data){
    $('style[data-mode="action_style"]').load("/bitrix/components/mibok/panel_creative.settings/ajax.php",{action: action, sub_action: 'CHANGE_PREVIEW', params: param})
    //})
}
...
function ChangeTheme(theme)
{
    ...
    if(theme !== undefined && theme != '')
        $('style[data-mode="action_style"]').load("/bitrix/components/mibok/panel_creative.settings/ajax.php",{action: action, sub_action: 'CHANGE_THEME', THEME: theme})
}

function ChangeView(type, ob)
{
    var action = $('.panel-settings input[name="panel_action"]').val();
    var valRadio = $(ob).val();
    var page = $('input[name=current_page]').val();
    var js = $('input[name=get_js]').val();

    if(type == 'slider')
    {
        var sub_action = 'SET_SLIDER';
    }
    else if(type == 'type_line')
    {
        var sub_action = 'SET_TYPE_LINE';
    }

    $.ajax({
        type: "POST",
        url: "/bitrix/components/mibok/panel_creative.settings/ajax.php",
        async: false,
        data: {valRadio: valRadio, action: action, sub_action: sub_action},
        success: function(){
            $.post(page,{slider: valRadio,page: page},function(data){
                data = $(data).filter('#wrapper').children();
                $('#wrapper').html(data);
                $.getScript(js);
            });
        }
...
$(document)
    .on('click', '.accord-header', function(){
        ...
        $('.accord-header .glyphicon').removeClass('glyphicon-chevron-up').addClass('glyphicon-chevron-down');
        if(icon == 'down')
    ...
    .on('click', '.switcher-item li', function(){
        var li = $(this);
        var id = li.attr('data-switch');
        var parent = li.parents('.accord-content');
        parent.find('.switcher-item li').removeClass('active');
        li.addClass('active');
        parent.find('.switcher-block > div').removeClass('active');
        parent.find('.switcher-block div#' + id).addClass('active');
    })
    .on('change', '.value-color', function(){
        var val = $(this).val();
        $(this).parents('.switcher-block > div.active').find(".custom-color").spectrum("set", val);
        ChangePreview();
    })
    .on('click', '.simplecolorpicker .color', function(){
        var val = $(this).attr('data-color');
        $(this).parents('.switcher-block > div.active').find(".custom-color").spectrum("set", val);
        $(this).parents('.switcher-block > div.active').find('input[name="value-color"]').val(val);
        ChangePreview();
    })
    .on('click', '#change_scheme', function(){
        var action = $('.panel-settings input[name="panel_action"]').val();
        var arSettings = {};
        //var bReload = false;
        var bReload = true;
        arSettings['theme'] = $('#work-theme input[type=radio]:checked').val();
        $('.switcher-block > div').each(function(indx, element){
            var val = $(element).find('input[name="value-color"]').val();
            arSettings[$(element).attr('id')] = val;
            if($(element).attr('id') == 'main_elements' && val != '')
        ...
        param = JSON.stringify(arSettings);
        $.post("/bitrix/components/mibok/panel_creative.settings/ajax.php",{action: action, sub_action: 'CHANGE_SCHEME', params: param},function(data){
//            if(bReload)
//                location.reload();
        })
    })
    .on('click', '#default_scheme', function(){
        var action = $('.panel-settings input[name="panel_action"]').val();
        var arSettings = {};
        $.post("/bitrix/components/mibok/panel_creative.settings/ajax.php",{action: action, sub_action: 'DEFAULT_SCHEME'},function(data){
            //if(bReload)
            location.reload();
        })
    })
    .on('change', '#work-theme input[type=radio]', function(){
        var valRadio = $(this).val();
        if(valRadio == 'user')
        {
            $('.wrapper-setting-user-color').slideDown("slow")
        }
        else
        {
            ChangeTheme(valRadio);
            $('.wrapper-setting-user-color').slideUp("slow");
        }
    })
    .on('change', '#work-slider input[type=radio]', function(){
        ChangeView('slider', $(this));
    })
    .on('change', '#work-type-line input[type=radio]', function(){
        ChangeView('type_line', $(this));
    })
;


/* End */
;; /* /bitrix/templates/creative_mibok_s2/js/html5shiv.min.js?15084419302733*/
; /* /bitrix/components/mibok/iblock.element.add/templates/consent_footer_form/mibok/iblock.element.add.form/.default/script.js?1508440934563*/
; /* /bitrix/templates/creative_mibok_s2/js/modernizr.js?150844193012017*/
; /* /bitrix/templates/creative_mibok_s2/js/jquery.min.js?150844193085582*/
; /* /bitrix/templates/creative_mibok_s2/js/flexibility.js?150844193017382*/
; /* /bitrix/templates/creative_mibok_s2/js/swiper.jquery.min.js?150844193068734*/
; /* /bitrix/templates/creative_mibok_s2/js/perfect-scrollbar.jquery.min.js?150844193025813*/
; /* /bitrix/templates/creative_mibok_s2/js/jquery.fancybox.js?150844193050725*/
; /* /bitrix/templates/creative_mibok_s2/js/tooltip/tooltipster.bundle.min.js?150844193039420*/
; /* /bitrix/templates/creative_mibok_s2/js/bootstrap.min.js?150844193029325*/
; /* /bitrix/templates/creative_mibok_s2/js/app.min.js?150844193011614*/
; /* /bitrix/components/mibok/panel_creative.settings/templates/.default/script.js?1487258427114358*/

//# sourceMappingURL=template_251349759e160b713c4d9f6cf5aadafd.map.js